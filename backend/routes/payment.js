...
router.post('/create', authenticate, (req, res) => {
  try {
    ...
    const amount = order.finalPrice || order.price * order.quantity;
...
// GET /api/payment/vnpay-return — User returns after VNPay payment
...
// GET /api/payment/vnpay-ipn — VNPay server notification (no redirect)
